...
def main():
    print("Loading data...")
    data_path = "base_df_post_eda_fixed.csv"
    if not os.path.exists(data_path):
        data_path = "Pakistan_Stock_Market_Prediction/base_df_post_eda_fixed.csv"
    ...
    output_img = 'Pakistan_Stock_Market_Prediction/pytorch_mamba_prediction.png'
    if not os.path.exists('Pakistan_Stock_Market_Prediction'):
        output_img = 'pytorch_mamba_prediction.png'
